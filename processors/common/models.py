...
class News(Base):
    ...
    summary = Column(Text)
    embedding = Column(Vector(384))  # Vector dimension should match your embedding model
    summary_embedding = Column(Vector(384))  # Vector dimension should match your embedding model
